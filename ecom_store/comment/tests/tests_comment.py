...
class TransactionTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.cart = Cart.objects.create(
            user=cls.user, product=Product.objects.get(id=1), qty=1
        )
    ...
    def test_get(
        ...
        self.handle_login()
        res = self.client.get(reverse("comment", args=[2]))
    ...
    def test_create_comment_returns_404_if_product_not_found(
        ...
        res = self.client.post(
            reverse("comment", args=[99]), data={"rating": 3, "content": "test comment"}
        )
    ...
    def test_update_comment_returns_404_if_comment_not_found(
        ...
        res = self.client.put(
            ...
            data={"rating": 3, "content": "test upddate comment"},
        )
    ...
    @freeze_time(
        "2025-03-09T20:43:00+07:00"
    )  # loncat 2 hari dari tanggal freeze_time class
    def test_update_comment_returns_403_if_exceeding_time_limit(
        ...
        self.assertEqual(res.status_code, 403)
        self.assertEqual(
            res.data["detail"], "Komentar sudah tidak bisa diedit setelah 24 jam"
        )
    ...
    def test_delete_comment_returns_404_if_comment_not_found(
        ...
        res = self.client.delete(reverse("comment", args=[99]))
    ...
    def test_delete_comment_returns_204_if_no_content(
        ...
        res = self.client.delete(reverse("comment", args=[2]))
